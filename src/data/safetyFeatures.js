...
export const safetyByCarId = {
  ...
  6: { backupCamera: true, parkingSensors: true, parkingSensorsDetail: "front + rear" },
  ...
  20: { backupCamera: true, parkingSensors: false, parkingSensorsDetail: "camera-based (no ultrasonic)" },
