...
const COLORFUL_HINT =
  /\b(blue|red|green|orange|yellow|teal|copper|rose|crimson|cosmic|solar|rush|underground|digital|lucid|performance|energetic|cardamom|moss|fusion|namsan|iceberg|runway|yacht|ocean|navarra|portimao|cape|river rock|gold|jupiter|thunder|radiant)\b/i;
